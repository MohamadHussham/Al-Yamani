...
const menuData = {
  beverages: [
    { name: { en: "Soft Drinks", ar: " مشروبات غازية" },
     description: {en: "Pepsi / Miranda / 7up", ar: "بيبسي / ميرندا / سفن أب" },
     id: "b1", price: "$1.5", image: "icon/ghazi.jpg" },

       { name: { en: "Kinza", ar: "كينزا" },
     description: {en: "", ar: "" },
     id: "b2", price: "$1.5", image: "icon/kinza.jpg" },

       { name: { en: "Fresh Orange", ar: "عصير برتقال طازجة" },
     description: {en: "", ar: "عصير برتقال طازجة من 100% فاكهة" },
     id: "b3", price: "$2", image: "icon/limon.jpg" },

       { name: { en: "Maccaw Juice", ar: "عصير مكوا" },
     description: {en: "Pineapple, Apple , Mango , Exotic", ar: "أناناس، تفاح، مانجو، عصائر متنوعة" },
     id: "b4", price: "$1", image: "icon/makkaw.jpg" },

       { name: { en: "Laban", ar: "لبن" },
     description: {en: "", ar: "" },
     id: "b5", price: "$1.5", image: "icon/airan.jpg" },

       { name: { en: "Lipton Iced Tea", ar: "شاي ليبتون البارد" },
     description: {en: "", ar: "" },
     id: "b6", price: "$1", image: "icon/icetea.jpg" },

       { name: { en: "Mineral Water", ar: "ماء معدني" },
     description: {en: "", ar: "" },
     id: "b7", price: "$0.5", image: "icon/water.jpg" },
    
    
  ],
  salads: [
    { name: { en: "Chicken Cesar Salad", ar: "سلطة دجاج سيزر" },
     description:{ en: "Cesar Dressing , Cherry Tomatoes, Crunchy Crotons & Parmesan Cheese .", 
      ar:"صلصة سيزر ، خس ، بندورة كرزية ، جبنة بارميزان، توست محمص" },
      id: "c1", price: "$7", image: "icon/cesarsalad.jpg" },


    { name: { en: "Chicken Pasta Salad", ar: "سلطة دجاج بالباستا" },
     description: { en: "Cesar Dressing , Lettuce , Olives , Cherry Tomatoes, Green Pepper , Corn , Crunchy Crotons &Oregano .",
      ar: "صلصة سيزر ، خس، زيتون ، فليفلة ، ذرة، أرغانو ، بندورة كرزية ، توست محمص" },
      id: "c2", price: "$8", image: "icon/checkinpastasalad.jpg" },


    { name: { en: "Crab Salad", ar: "سلطة كراب" },
     description: { en: "Crab Dressing , Lettuce , Corn , Cherry Tomatoes, Carrot & Crunchy Crotons.",
      ar: "صلصة كراب ، خس ، ذرة ، بندورة كرزية ، جزر ، توست محمص" },
     id: "c3", price: "$7", image: "icon/crabsalad.jpg" },



    { name: { en: "Shrimps Salad", ar: "سلطة قريدس" },
     description: { en: "Crab Dressing , Lettuce , Carrots , Cherry Tomatoes & Crunchy Crotons .",
      ar: "صلصة قريدس ، خس، جزر ، بندورة كرزية ، توست محمص" },
     id: "c4", price: "$8", image: "icon/shrimpssalad.jpg" },



    { name: { en: "Shrimps & Crab Salad", ar: "سلطة قريدس مع كراب" }, 
      description: { en: "Crab Dressing , Lettuce , Carrots , Cherry Tomatoes & Crunchy Crotons .",
       ar: "صلصة كراب ، خس ، بندورة كرزية ، جزر ، توست محمص" },
     id: "c5", price: "$10", image: "icon/shrimpsandcrab.jpg" }
...
const translations = {
  en: {
    brand: "Welcome to Al-Yamani Restaurant",
  ...
  ar: {
    brand: " أهلاً وسهلاً بكم في مطعم اليماني",
    back: "العودة للقائمة",
    summary: "ملخص الطلب",
    ...
    catTitles: {
      ...
      shawarma: "شاورما 🌯",
      snack: "سناك 🌮",
      meatburger: "برجر لحمة 🍔",
      chickenburger: "برجر دجاج 🍔",
      chicken: "دجاج 🍗",
      pizza: "بيتزا و باستا 🍕🍝",
      platters: "صحون 🍽️",
      sauce: "صوص 🥫",
...
items.forEach(item => {
    ...
    itemsHtml += `
        <div class="summary-item" style="display: flex; flex-direction: row; justify-content: space-between; align-items: flex-start; border-bottom: 1px solid #eee; padding: 12px 0; width: 100%;">
            <strong style="flex: 1; text-align: ${isAr ? 'right' : 'left'}; font-size: 1.1rem; color:#a41212">
                ${item.name[currentLang]}
            </strong>
            <span dir="ltr" style="font-weight: bold;margin-${marginSide}: 15px; white-space: nowrap; font-family: monospace; color: #a41212;">
...
container.innerHTML = `<h1>${translations[currentLang].summary}</h1>` + itemsHtml;
  ...
  // 4. Grand Total Row
  container.innerHTML += `
        <div style="display: flex; justify-content: space-between; margin-top: 20px; border-top: 2px solid #333; padding-top: 10px; color:#a41212;">
 ...
 if (typeof orderNote !== 'undefined' && orderNote && orderNote.trim() !== "") {
    ...
    container.innerHTML  += `
        <div style="margin-top: 20px; padding: 12px; background: rgba(255,255,255,0.1); border-radius: 8px; border-inline-start: 5px solid #00008b; text-align: ${isAr ? 'right' : 'left'};">
            ...
            <p style="margin: 0; font-style: italic; color: #a41212;">${orderNote}</p>
        </div>`;
  }
...
let dropdownHtml = `
    <div style="margin-top: 20px; text-align: ${isAr ? 'right' : 'left'};">
        <label style="display: block; margin-bottom: 8px; font-weight: bold; color:#a41212;">${dropdownLabel}</label>
...
deliveryDropdown.addEventListener('change', function() {
    ...
    if (choice === 'fast') {
        ...
        dynamicArea.innerHTML = `<fieldset style="border: 1px solid #444; border-radius: 8px; padding: 10px;background-color:#a41212;">
    <legend style="padding: 0 10px; font-size: 0.9rem; color:red;">${legend}</legend>
    <select id="tableInput" style="width: 75%; background-color:white; padding:2px; border: none; color: black; outline: none; cursor: pointer;">
        ...
        dynamicArea.innerHTML = `
            <fieldset style="border: 1px solid #444; border-radius: 8px; padding: 10px;background-color:#a41212;">
                <legend style="padding: 0 10px; font-size: 0.9rem;color:red;">${legend}</legend>
